...
if __name__ == '__main__':
    ...
    train_data = np.load(r'学长代码测试\data\timeStretch_train_data.npy', allow_pickle=True)
    valid_data = np.load(r'学长代码测试\data\timeStretch_train_data.npy', allow_pickle=True)
    test_data = np.load(r'学长代码测试\data\test_data.npy', allow_pickle=True)

    train_label = np.load(r'学长代码测试\data\timeStretch_train_label.npy', allow_pickle=True)
    valid_label = np.load(r'学长代码测试\data\timeStretch_train_label.npy', allow_pickle=True)
