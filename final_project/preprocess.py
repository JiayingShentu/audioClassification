...
if __name__ == '__main__':
    ...
    # write_to_json('D:\\毕设相关\\audioClassification\\final_project\\label_dict.json', label_dict)
    # write_to_json('D:\\毕设相关\\audioClassification\\final_project\\num_dict.json', num_dict)
    ...
    np.save(r'D:\毕设相关\audioClassification\final_predata\train_data.npy', train_data)
    np.save(r'D:\毕设相关\audioClassification\final_predata\train_label.npy', train_label)
    np.save(r'D:\毕设相关\audioClassification\final_predata\valid_data.npy', valid_data)
    np.save(r'D:\毕设相关\audioClassification\final_predata\valid_label.npy', valid_label)
    np.save(r'D:\毕设相关\audioClassification\final_predata\test_data.npy', test_data)
    np.save(r'D:\毕设相关\audioClassification\final_predata\test_label.npy', test_label)
