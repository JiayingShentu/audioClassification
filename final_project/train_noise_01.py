...
if __name__ == '__main__':
    ...
    train_data = np.load(r'final_predata\addNoise01_train_data.npy', allow_pickle=True)
    valid_data = np.load(r'final_predata\addNoise01_valid_data.npy', allow_pickle=True)
    test_data = np.load(r'final_predata\test_data.npy', allow_pickle=True)

    train_label = np.load(r'final_predata\addNoise01_train_label.npy', allow_pickle=True)
    valid_label = np.load(r'final_predata\addNoise01_valid_label.npy', allow_pickle=True)
    ...
    _, precision_test = test(model, X_test=test_data_tensor, Y_test=test_labels_tensor)
    print("test precision: {}%".format(str(precision_test * 100)))
