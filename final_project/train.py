...
if __name__ == '__main__':
    ...
    #                                                                                   test_size=0.5)
    train_data = np.load(r'final_predata\train_data.npy', allow_pickle=True)
    valid_data = np.load(r'final_predata\valid_data.npy', allow_pickle=True)
    test_data = np.load(r'final_predata\test_data.npy', allow_pickle=True)

    train_label = np.load(r'final_predata\train_label.npy', allow_pickle=True)
    valid_label = np.load(r'final_predata\valid_label.npy', allow_pickle=True)
